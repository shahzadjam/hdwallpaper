   ...
   <!--  bodyArea start  -->
				...
				<div id="demo5">                   
                          ...
                          <div class="login fLeft">
                                    ...
                                    <input type="text" name="first_name" class="username" placeholder="Username">
                                    <input type="text" name="first_name" class="username" placeholder="Password">
                                    
                                    <div class="loginButton fLeft">
                                    	<a href="#">Login</a>
                                    </div>
