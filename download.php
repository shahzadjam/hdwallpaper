...
$doc_path = $_SERVER['DOCUMENT_ROOT']."/hdwallpaper/";
$url_path = site_url("/");
$path= str_replace($url_path, $doc_path, $_GET['download_file']);
...
$url_path = site_url("/");
$new_loc= str_replace($url_path, $url_path.$new_loc_folder, $_GET['download_file']);

define('APPLICATION_PATH',  dirname(__FILE__));	
$new_path =	resize_image('max',$_GET['download_file'], APPLICATION_PATH . '/tmp/myfile.jpg', $_GET['w'],$_GET['h']);
$fullPath = APPLICATION_PATH . '/tmp/myfile.jpg';
